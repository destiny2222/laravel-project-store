        ...
        <div class="row">
            ...
            <div class="col-6 col-sm-6 col-md-6 col-lg-3 align-self-center justify-content-start d-flex">
                ...
                <div class="logo"><a href="index.html">
                    <img class="logo-img mh-100" src="{{  asset('assets/images/logo-demo2.png') }}" alt="logo" title="Optimal Multipurpose eCommerce Bootstrap 5 Html Template" width="140" /><span class="logo-txt d-none">Optimal</span></a></div>
                <!--End Logo-->
            </div>
                    ...
                    <div class="col-1 col-sm-12 col-md-12 col-lg-12 align-self-center d-menu-col">
                        ...
                        <nav class="grid__item" id="AccessibleNav">
                            <ul id="siteNav" class="site-nav medium center hidearrow">
                                ...
                                <li class="lvl1 parent megamenu"><a href="#;">Shop <i class="an an-angle-down-l"></i></a></li>
                                <li class="lvl1 parent megamenu"><a href="#;">Product <i class="an an-angle-down-l"></i></a> </li>
                                <li class="lvl1 parent megamenu"><a href="#">Features <i class="an an-angle-down-l"></i><span class="navLbl new">New</span></a></li>
